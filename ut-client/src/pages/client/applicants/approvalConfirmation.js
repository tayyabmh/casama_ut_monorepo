                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        By approving the user you are confirming for an introduction to be made by Casama team. Are you sure you want to approve this user?
                      </p>
                    </div>
                  </div>
                </div>
